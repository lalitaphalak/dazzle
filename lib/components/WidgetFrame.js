...
const cardTarget = {
  hover(props, monitor, component) {
    ...
    if (monitor.getItem().columnIndex === columnIndex) {
      ...
      props.onMove(newLayout, rowIndex, columnIndex, dragIndex, hoverIndex);
...
class WidgetFrame extends Component {
  render() {
    ...
    if (frameComponent) {
      ...
      selected = createElement(frameComponent, {	children,	editable, title, onRemove: this.remove, rowIndex, columnIndex, widgetIndex }); // eslint-disable-line max-len
    } else {
